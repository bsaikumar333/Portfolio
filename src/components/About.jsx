...
export default function About() {
  return (
    <section className="bg-slate-50 text-slate-900 py-24 px-6 sm:px-12 lg:px-24 relative overflow-hidden" id="about">
      {/* Ambient 3D Shape */}
      ...
      <div className="max-w-4xl mx-auto z-10 relative">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold mb-4 font-outfit">
            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">My Journey</span>
          </h2>
        ...
        <motion.div
          ...
          className="glass-card-light p-8 sm:p-12 rounded-3xl relative overflow-hidden group"
        >
          ...
          <div className="relative z-10 space-y-6 text-slate-600 text-lg leading-relaxed font-light">
            <p>
              Hello! I'm <strong className="text-slate-900 font-medium">Bayineni Sai Kumar</strong>, currently a second-year BSc student at the prestigious BITS Pilani. My journey in technology began with a deep-seated curiosity about how things work behind the screen, which quickly evolved into a profound passion for Full-Stack Development.
            </p>
            <p>
