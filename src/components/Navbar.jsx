...
export default function Navbar() {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#0f172a]/80 backdrop-blur-lg shadow-xl border-b border-white/5 py-4' : 'bg-transparent py-8'
        }`}
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24 flex items-center justify-between">
        ...
        <nav className="flex md:hidden items-center gap-4">
          ...
          <a href="#contact" className="text-sm font-medium text-cyan-400">Contact</a>
        </nav>
